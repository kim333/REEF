...
import com.microsoft.reef.examples.groupcomm.matmul.MatMultDriver.Parameters.LearnRate;
import com.microsoft.reef.examples.groupcomm.matmul.MatMultDriver.Parameters.NumParam;
import com.microsoft.reef.examples.groupcomm.matmul.MatMultDriver.Parameters.TargetParam;
...
public class TaskSubmitter implements EventHandler<Iterable<ActiveContext>> {
   ...
   */
  public TaskSubmitter(int numberOfComputeTasks, int nameServicePort, double learnRate, int numParam, int targetParam) {
  ...
  private Configuration getComputeTaskConfig(final ComparableIdentifier compTaskId) {
    try {
      ...
      final JavaConfigurationBuilder b = Tang.Factory.getTang().newConfigurationBuilder()
    		  ...
    		  .bindNamedParameter(LearnRate.class, ""+learnRate)
    		  .bindNamedParameter(TargetParam.class, ""+targetParam);
